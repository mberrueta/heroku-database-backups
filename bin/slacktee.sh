...
# ----------
webhook_url=$SLACK_WEBHOOK_URL       # Incoming Webhooks integration URL
channel=$SLACK_CHANNEL               # Default channel to post messages. '#' is prepended, if it doesn't start with '#' or '@'.
username="bot"                  # Default username to post messages.
